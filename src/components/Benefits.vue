    ...
    <div class="grid lg:grid-cols-2 place-items-center lg:gap-24">
      <div>
        ...
        <p class="text-xl text-muted-foreground mb-8">
          Welcome to Two Lions Driving School, where safety meets excellence in driver education. Our mission is to
          equip students with the knowledge, skills, and confidence they need to become responsible and proficient
          drivers.
        </p>
      </div>
